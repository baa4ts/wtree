    ...
    return (
        <View style={[styles.container, { backgroundColor: background }]}>
            ...
            <View style={styles.tipsRow}>
                ...
                <Text style={[styles.tipsText, { color: subtext, fontFamily: Fonts.rounded }]}>
                    Tips: El sensor ID se obtiene en el momento que conectas tu sensor a tu red Wifi
                </Text>
            </View>
            ...
            <View style={styles.buttonsRow}>
                ...
                <TouchableOpacity
                    style={[styles.button, { backgroundColor: "#e63946", marginRight: 8 }]}
                    onPress={() => Alert.alert("Aviso", "Mantén presionado para cancelar")}
